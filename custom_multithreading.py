...
class ChromeManager(Thread):
    ...
    def load_drivers(self, n, chromedriver_path, timeout=30, *extension_args):
        ...
        for driver_id in xrange(n):
            self.drivers.append(DriverThread(driver_id, chromedriver_path, options, timeout))
        return True
...
class DriverThread(Thread):
    def __init__(self, driver_thread_id, chrome_path, options, timeout):
        ...
        self.chrome_driver.set_window_position(2300, 0)
